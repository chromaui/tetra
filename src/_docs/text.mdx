...
<Meta title="Core Concepts/Texts" />
...
If you want more flexibility, you can use our style helpers to create your own text component. You can use the following props to customise your text:

- `typography.heading56`
- `typography.heading48`
- `typography.heading40`
- `typography.heading36`
